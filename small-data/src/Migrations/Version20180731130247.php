 ...
 */
final class Version20180731130247 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE occurrences_id_seq CASCADE');
        $this->addSql('CREATE SEQUENCE occurrence_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER SEQUENCE species_id_seq INCREMENT BY 1');
        $this->addSql('DROP SEQUENCE occurrence_id_seq CASCADE');
        $this->addSql('CREATE SEQUENCE occurrences_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
