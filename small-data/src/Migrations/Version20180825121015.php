 ...
 */
final class Version20180825121015 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE occurrence (id INT NOT NULL, species_id INT DEFAULT NULL, inputter_id INT DEFAULT NULL, last_modifier_id INT NOT NULL, event_date DATE NOT NULL, vernacular_name TEXT DEFAULT NULL, scientific_name_at_collection TEXT DEFAULT NULL, decimal_longitude DOUBLE PRECISION NOT NULL, decimal_latitude DOUBLE PRECISION NOT NULL, locality TEXT DEFAULT NULL, location_id TEXT DEFAULT NULL, occurrence_remarks TEXT DEFAULT NULL, associated_media_url TEXT DEFAULT NULL, occurrence_created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, last_modified_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, validation BOOLEAN NOT NULL, PRIMARY KEY(id))');
