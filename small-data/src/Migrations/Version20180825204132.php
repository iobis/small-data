 ...
 */
final class Version20180825204132 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE occurrence RENAME COLUMN validation TO is_validated');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER SEQUENCE inputter_id_seq INCREMENT BY 1');
        $this->addSql('ALTER SEQUENCE occurrence_id_seq INCREMENT BY 1');
        $this->addSql('ALTER TABLE occurrence RENAME COLUMN is_validated TO validation');
    }
}
